...
public class OnionBlocker extends Entity implements WorldObject{
    ...
    public OnionBlocker(JSONObject saveData) {
        super();
        this.setModel(ModelManager.getInstance().loadModel("onion.obj"));
        this.setTexture("onion.png");
//        this.setScale(0.3f);
        this.setType(EnumEntityType.ONION_BLOCKER);
        initialize(saveData);
    }
